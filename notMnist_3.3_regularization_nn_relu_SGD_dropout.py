...
with graph.as_default():
  ...
  # Dropout Regulariztion to the Hidden Layer
...
with tf.Session(graph=graph) as session:
  ...
  for step in range(num_steps):
    ...
    if (step % 500 == 0):
      ...
      print("Minibatch accuracy: %.1f%%" % accuracy(
        train_prediction.eval(feed_dict=feed_dict), batch_labels))
  ...
  # Dropout Regularization made things worse, Some people report that for
  # Dropout to work correctly, the dataset must be much bigger